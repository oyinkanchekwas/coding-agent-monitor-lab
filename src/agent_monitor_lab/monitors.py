...
class TestWeakeningMonitor(PatternMonitor):
    ...
    rules = (
        PatternRule(
            ...
            remediation="Justify the skip with a tracked issue, or fix the failing behavior instead.",
            confidence=0.78,
        ...
        PatternRule(
            ...
            remediation="Assert the actual behavior that would catch the regression.",
            confidence=0.74,
